...
var convertColumns = function (t, e) { if (!t || !e || !e.series)
    ...
    return []; var r = []; return t.rows && t.rows.forEach(function (t) { var o = t.cells, a = []; e.forEach(function (t) { var e = o[t]; e && e.obj && a.push("NR" === e.obj.t ? parseFloat(e.obj.k) : e.obj.k); }), r.push(a); }), r; }, KetchupChart = function () { function t() { this.config = { type: ChartType.Hbar, axe: "Col1", series: ["Col2", "Col3"] }; } return t.prototype.componentDidLoad = function () { if (this.config.axe && this.config.series && google)
    try {
    ...
    try {
        ...
        console.error(t);
    } return this.config.hasOwnProperty("leg") && !this.config.leg && (t.legend = { position: "none" }), !this.config.stacked || ChartType.Hbar !== this.config.type && ChartType.Vbar !== this.config.type || (t.isStacked = !0), this.config.title && (t.title = this.config.title, t.titleTextStyle = {}, this.config.titleColor && (t.titleTextStyle.color = this.config.titleColor), this.config.titleSize && (t.titleTextStyle.fontSize = this.config.titleSize)), t; }, t.prototype._createChart = function () { var t = convertColumns(this.data, this.config), e = convertRows(this.data, t), r = new google.visualization.arrayToDataTable([t].concat(e)); this.gChart = this._createGoogleChart(); var o = this._createGoogleChartOptions(); this.gChart.draw(r, o); }, t.prototype.render = function () { var t = this; return mycomponent_core_js_1.h("div", { id: "chart", ref: function (e) { return t.chartContainer = e; } }); }, Object.defineProperty(t, "is", { get: function () { return "ketchup-chart"; }, enumerable: !0, configurable: !0 }), Object.defineProperty(t, "encapsulation", { get: function () { return "shadow"; }, enumerable: !0, configurable: !0 }), Object.defineProperty(t, "properties", { get: function () { return { config: { type: "Any", attr: "config" }, data: { type: "Any", attr: "data" } }; }, enumerable: !0, configurable: !0 }), Object.defineProperty(t, "style", { get: function () { return ""; }, enumerable: !0, configurable: !0 }), t; }();
exports.KetchupChart = KetchupChart;
