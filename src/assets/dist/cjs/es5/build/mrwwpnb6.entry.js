...
var hookCallback, some, numeral = createCommonjsModule(function (e) { var t, o; t = commonjsGlobal, o = function () { var e, t, o, r, n, a = {}, i = {}, s = { currentLocale: "en", zeroFormat: null, nullFormat: null, defaultFormat: "0,0", scalePercentBy100: !0 }, l = { currentLocale: s.currentLocale, zeroFormat: s.zeroFormat, nullFormat: s.nullFormat, defaultFormat: s.defaultFormat, scalePercentBy100: s.scalePercentBy100 }; function u(e, t) { this._input = e, this._value = t; } return (e = function (o) { var r, n, i, s; if (e.isNumeral(o))
    r = o.value();
    ...
    if (l.zeroFormat && o === l.zeroFormat)
        ...
        for (n in a)
            if ((s = "function" == typeof a[n].regexps.unformat ? a[n].regexps.unformat() : a[n].regexps.unformat) && o.match(s)) {
                i = a[n].unformat;
                break;
            }
        r = (i = i || e._.stringToNumber)(o);
    }
else
    r = Number(o) || null; return new u(o, r); }).version = "2.0.6", e.isNumeral = function (e) { return e instanceof u; }, e._ = t = { numberToFormat: function (t, o, r) { var n, a, s, l, u, c, d, h, f = i[e.options.currentLocale], m = !1, p = !1, g = "", y = "", k = !1; if (t = t || 0, s = Math.abs(t), e._.includes(o, "(") ? (m = !0, o = o.replace(/[\(|\)]/g, "")) : (e._.includes(o, "+") || e._.includes(o, "-")) && (c = e._.includes(o, "+") ? o.indexOf("+") : t < 0 ? o.indexOf("-") : -1, o = o.replace(/[\+|\-]/g, "")), e._.includes(o, "a") && (a = !!(a = o.match(/a(k|m|b|t)?/)) && a[1], e._.includes(o, " a") && (g = " "), o = o.replace(new RegExp(g + "a[kmbt]?"), ""), s >= 1e12 && !a || "t" === a ? (g += f.abbreviations.trillion, t /= 1e12) : s < 1e12 && s >= 1e9 && !a || "b" === a ? (g += f.abbreviations.billion, t /= 1e9) : s < 1e9 && s >= 1e6 && !a || "m" === a ? (g += f.abbreviations.million, t /= 1e6) : (s < 1e6 && s >= 1e3 && !a || "k" === a) && (g += f.abbreviations.thousand, t /= 1e3)), e._.includes(o, "[.]") && (p = !0, o = o.replace("[.]", ".")), l = t.toString().split(".")[0], u = o.split(".")[1], d = o.indexOf(","), n = (o.split(".")[0].split(",")[0].match(/0/g) || []).length, u ? (e._.includes(u, "[") ? (u = (u = u.replace("]", "")).split("["), y = e._.toFixed(t, u[0].length + u[1].length, r, u[1].length)) : y = e._.toFixed(t, u.length, r), l = y.split(".")[0], y = e._.includes(y, ".") ? f.delimiters.decimal + y.split(".")[1] : "", p && 0 === Number(y.slice(1)) && (y = "")) : l = e._.toFixed(t, 0, r), g && !a && Number(l) >= 1e3 && g !== f.abbreviations.trillion)
        ...
        } if (e._.includes(l, "-") && (l = l.slice(1), k = !0), l.length < n)
        for (var v = n - l.length; v > 0; v--)
            l = "0" + l; return d > -1 && (l = l.toString().replace(/(\d)(?=(\d{3})+(?!\d))/g, "$1" + f.delimiters.thousands)), 0 === o.indexOf(".") && (l = ""), h = l + y + (g || ""), m ? h = (m && k ? "(" : "") + h + (m && k ? ")" : "") : c >= 0 ? h = 0 === c ? (k ? "-" : "+") + h : h + (k ? "-" : "+") : k && (h = "-" + h), h; }, stringToNumber: function (e) { var t, o, r, n = i[l.currentLocale], a = e, s = { thousand: 3, million: 6, billion: 9, trillion: 12 }; if (l.zeroFormat && e === l.zeroFormat)
        o = 0;
    else if (l.nullFormat && e === l.nullFormat || !e.replace(/[^0-9]+/g, "").length)
        o = null;
    else {
        for (t in o = 1, "." !== n.delimiters.decimal && (e = e.replace(/\./g, "").replace(n.delimiters.decimal, ".")), s)
        ...
        a in r && (o = t(o, r[a], a, r)); return o; }, multiplier: function (e) { var t = e.toString().split("."); return t.length < 2 ? 1 : Math.pow(10, t[1].length); }, correctionFactor: function () { return Array.prototype.slice.call(arguments).reduce(function (e, o) { var r = t.multiplier(o); return e > r ? e : r; }, 1); }, toFixed: function (e, t, o, r) { var n, a, i, s, l = e.toString().split("."), u = t - (r || 0); return n = 2 === l.length ? Math.min(Math.max(l[1].length, u), t) : u, i = Math.pow(10, n), s = (o(e + "e+" + n) / i).toFixed(n), r > t - n && (a = new RegExp("\\.?0{1," + (r - (t - n)) + "}$"), s = s.replace(a, "")), s; } }, e.options = l, e.formats = a, e.locales = i, e.locale = function (e) { return e && (l.currentLocale = e.toLowerCase()), l.currentLocale; }, e.localeData = function (e) { if (!e)
    return i[l.currentLocale]; if (e = e.toLowerCase(), !i[e])
    throw new Error("Unknown locale : " + e); return i[e]; }, e.reset = function () { for (var e in s)
    l[e] = s[e]; }, e.zeroFormat = function (e) { l.zeroFormat = "string" == typeof e ? e : null; }, e.nullFormat = function (e) { l.nullFormat = "string" == typeof e ? e : null; }, e.defaultFormat = function (e) { l.defaultFormat = "string" == typeof e ? e : "0.0"; }, e.register = function (e, t, o) { if (t = t.toLowerCase(), this[e + "s"][t])
    throw new TypeError(t + " " + e + " already registered."); return this[e + "s"][t] = o, o; }, e.validate = function (t, o) { var r, n, a, i, s, l, u, c; if ("string" != typeof t && (t += "", console.warn && console.warn("Numeral.js: Value is not string. It has been co-erced to: ", t)), (t = t.trim()).match(/^\d+$/))
    return !0; if ("" === t)
    return !1; try {
    u = e.localeData(o);
}
    ...
    u = e.localeData(e.locale());
} return a = u.currency.symbol, s = u.abbreviations, r = u.delimiters.decimal, n = "." === u.delimiters.thousands ? "\\." : u.delimiters.thousands, !(null !== (c = t.match(/^[^\d]+/)) && (t = t.substr(1), c[0] !== a) || null !== (c = t.match(/[^\d]+$/)) && (t = t.slice(0, -1), c[0] !== s.thousand && c[0] !== s.million && c[0] !== s.billion && c[0] !== s.trillion) || (l = new RegExp(n + "{2}"), t.match(/[^\d.,]/g) || (i = t.split(r)).length > 2 || (i.length < 2 ? !i[0].match(/^\d+.*\d$/) || i[0].match(l) : 1 === i[0].length ? !i[0].match(/^\d+$/) || i[0].match(l) || !i[1].match(/^\d+$/) : !i[0].match(/^\d+.*\d$/) || i[0].match(l) || !i[1].match(/^\d+$/)))); }, e.fn = u.prototype = { clone: function () { return e(this); }, format: function (t, o) { var r, n, i, s = this._value, u = t || l.defaultFormat; if (o = o || Math.round, 0 === s && null !== l.zeroFormat)
        n = l.zeroFormat;
        ...
        i *= a || 1;
    } return i; } }), e.register("format", "currency", { regexps: { format: /(\$)/ }, format: function (t, o, r) { var n, a, i = e.locales[e.options.currentLocale], s = { before: o.match(/^([\+|\-|\(|\s|\$]*)/)[0], after: o.match(/([\+|\-|\)|\s|\$]*)$/)[0] }; for (o = o.replace(/\s?\$\s?/, ""), n = e._.numberToFormat(t, o, r), t >= 0 ? (s.before = s.before.replace(/[\-\(]/, ""), s.after = s.after.replace(/[\-\)]/, "")) : t < 0 && !e._.includes(s.before, "-") && !e._.includes(s.before, "(") && (s.before = "-" + s.before), a = 0; a < s.before.length; a++)
        switch (s.before[a]) {
            case "$":
                n = e._.insert(n, i.currency.symbol, a);
                break;
            case " ": n = e._.insert(n, " ", a + i.currency.symbol.length - 1);
        } for (a = s.after.length - 1; a >= 0; a--)
        switch (s.after[a]) {
            case "$":
                n = a === s.after.length - 1 ? n + i.currency.symbol : e._.insert(n, i.currency.symbol, -(s.after.length - (1 + a)));
                break;
            case " ": n = a === s.after.length - 1 ? n + " " : e._.insert(n, " ", -(s.after.length - (1 + a) + i.currency.symbol.length - 1));
...
function compareArrays(e, t, o) { var r, n = Math.min(e.length, t.length), a = Math.abs(e.length - t.length), i = 0; for (r = 0; r < n; r++)
    (o && e[r] !== t[r] || !o && toInt(e[r]) !== toInt(t[r])) && i++; return i + a; }
...
function handleStrictParse(e, t, o) { var r, n, a, i = e.toLocaleLowerCase(); if (!this._monthsParse)
    for (this._monthsParse = [], this._longMonthsParse = [], this._shortMonthsParse = [], r = 0; r < 12; ++r)
        a = createUTC([2e3, r]), this._shortMonthsParse[r] = this.monthsShort(a, "").toLocaleLowerCase(), this._longMonthsParse[r] = this.months(a, "").toLocaleLowerCase(); return o ? "MMM" === t ? -1 !== (n = indexOf.call(this._shortMonthsParse, i)) ? n : null : -1 !== (n = indexOf.call(this._longMonthsParse, i)) ? n : null : "MMM" === t ? -1 !== (n = indexOf.call(this._shortMonthsParse, i)) ? n : -1 !== (n = indexOf.call(this._longMonthsParse, i)) ? n : null : -1 !== (n = indexOf.call(this._longMonthsParse, i)) ? n : -1 !== (n = indexOf.call(this._shortMonthsParse, i)) ? n : null; }
...
function createDate(e, t, o, r, n, a, i) { var s; return e < 100 && e >= 0 ? (s = new Date(e + 400, t, o, r, n, a, i), isFinite(s.getFullYear()) && s.setFullYear(e)) : s = new Date(e, t, o, r, n, a, i), s; }
...
function dayOfYearFromWeeks(e, t, o, r, n) { var a, i, s = 1 + 7 * (t - 1) + (7 + o - r) % 7 + firstWeekOffset(e, r, n); return s <= 0 ? i = daysInYear(a = e - 1) + s : s > daysInYear(e) ? (a = e + 1, i = s - daysInYear(e)) : (a = e, i = s), { year: a, dayOfYear: i }; }
function weekOfYear(e, t, o) { var r, n, a = firstWeekOffset(e.year(), t, o), i = Math.floor((e.dayOfYear() - a - 1) / 7) + 1; return i < 1 ? r = i + weeksInYear(n = e.year() - 1, t, o) : i > weeksInYear(e.year(), t, o) ? (r = i - weeksInYear(e.year(), t, o), n = e.year() + 1) : (n = e.year(), r = i), { week: r, year: n }; }
...
function handleStrictParse$1(e, t, o) { var r, n, a, i = e.toLocaleLowerCase(); if (!this._weekdaysParse)
    for (this._weekdaysParse = [], this._shortWeekdaysParse = [], this._minWeekdaysParse = [], r = 0; r < 7; ++r)
        a = createUTC([2e3, 1]).day(r), this._minWeekdaysParse[r] = this.weekdaysMin(a, "").toLocaleLowerCase(), this._shortWeekdaysParse[r] = this.weekdaysShort(a, "").toLocaleLowerCase(), this._weekdaysParse[r] = this.weekdays(a, "").toLocaleLowerCase(); return o ? "dddd" === t ? -1 !== (n = indexOf.call(this._weekdaysParse, i)) ? n : null : "ddd" === t ? -1 !== (n = indexOf.call(this._shortWeekdaysParse, i)) ? n : null : -1 !== (n = indexOf.call(this._minWeekdaysParse, i)) ? n : null : "dddd" === t ? -1 !== (n = indexOf.call(this._weekdaysParse, i)) ? n : -1 !== (n = indexOf.call(this._shortWeekdaysParse, i)) ? n : -1 !== (n = indexOf.call(this._minWeekdaysParse, i)) ? n : null : "ddd" === t ? -1 !== (n = indexOf.call(this._shortWeekdaysParse, i)) ? n : -1 !== (n = indexOf.call(this._weekdaysParse, i)) ? n : -1 !== (n = indexOf.call(this._minWeekdaysParse, i)) ? n : null : -1 !== (n = indexOf.call(this._minWeekdaysParse, i)) ? n : -1 !== (n = indexOf.call(this._weekdaysParse, i)) ? n : -1 !== (n = indexOf.call(this._shortWeekdaysParse, i)) ? n : null; }
...
function computeWeekdaysParse() { function e(e, t) { return t.length - e.length; } var t, o, r, n, a, i = [], s = [], l = [], u = []; for (t = 0; t < 7; t++)
    o = createUTC([2e3, 1]).day(t), r = this.weekdaysMin(o, ""), n = this.weekdaysShort(o, ""), a = this.weekdays(o, ""), i.push(r), s.push(n), l.push(a), u.push(r), u.push(n), u.push(a); for (i.sort(e), s.sort(e), l.sort(e), u.sort(e), t = 0; t < 7; t++)
    s[t] = regexEscape(s[t]), l[t] = regexEscape(l[t]), u[t] = regexEscape(u[t]); this._weekdaysRegex = new RegExp("^(" + u.join("|") + ")", "i"), this._weekdaysShortRegex = this._weekdaysRegex, this._weekdaysMinRegex = this._weekdaysRegex, this._weekdaysStrictRegex = new RegExp("^(" + l.join("|") + ")", "i"), this._weekdaysShortStrictRegex = new RegExp("^(" + s.join("|") + ")", "i"), this._weekdaysMinStrictRegex = new RegExp("^(" + i.join("|") + ")", "i"); }
...
function configFromArray(e) { var t, o, r, n, a, i = []; if (!e._d) {
...
function dayOfYearFromWeekInfo(e) { var t, o, r, n, a, i, s, l; if (null != (t = e._w).GG || null != t.W || null != t.E)
    a = 1, i = 4, o = defaults(t.GG, e._a[YEAR], weekOfYear(createLocal(), 1, 4).year), r = defaults(t.W, 1), ((n = defaults(t.E, 1)) < 1 || n > 7) && (l = !0);
else {
    a = e._locale._week.dow, i = e._locale._week.doy;
    var u = weekOfYear(createLocal(), a, i);
    o = defaults(t.gg, e._a[YEAR], u.year), r = defaults(t.w, u.week), null != t.d ? ((n = t.d) < 0 || n > 6) && (l = !0) : null != t.e ? (n = t.e + a, (t.e < 0 || t.e > 6) && (l = !0)) : n = a;
} r < 1 || r > weeksInYear(o, a, i) ? getParsingFlags(e)._overflowWeeks = !0 : null != l ? getParsingFlags(e)._overflowWeekday = !0 : (s = dayOfYearFromWeeks(o, r, n, a, i), e._a[YEAR] = s.year, e._dayOfYear = s.dayOfYear); }
...
function configFromISO(e) { var t, o, r, n, a, i, s = e._i, l = extendedIsoRegex.exec(s) || basicIsoRegex.exec(s); if (l) {
    ...
    e._f = n + (a || "") + (i || ""), configFromStringAndFormat(e);
}
else
    e._isValid = !1; }
var rfc2822 = /^(?:(Mon|Tue|Wed|Thu|Fri|Sat|Sun),?\s)?(\d{1,2})\s(Jan|Feb|Mar|Apr|May|Jun|Jul|Aug|Sep|Oct|Nov|Dec)\s(\d{2,4})\s(\d\d):(\d\d)(?::(\d\d))?\s(?:(UT|GMT|[ECMP][SD]T)|([Zz])|([+-]\d{4}))$/;
function extractFromRFC2822Strings(e, t, o, r, n, a) { var i = [untruncateYear(e), defaultLocaleMonthsShort.indexOf(t), parseInt(o, 10), parseInt(r, 10), parseInt(n, 10)]; return a && i.push(parseInt(a, 10)), i; }
...
function Duration(e) { var t = normalizeObjectUnits(e), o = t.year || 0, r = t.quarter || 0, n = t.month || 0, a = t.week || t.isoWeek || 0, i = t.day || 0, s = t.hour || 0, l = t.minute || 0, u = t.second || 0, c = t.millisecond || 0; this._isValid = isDurationValid(t), this._milliseconds = +c + 1e3 * u + 6e4 * l + 1e3 * s * 60 * 60, this._days = +i + 7 * a, this._months = +n + 3 * r + 12 * o, this._data = {}, this._locale = getLocale(), this._bubble(); }
...
function createDuration(e, t) { var o, r, n, a = e, i = null; return isDuration(e) ? a = { ms: e._milliseconds, d: e._days, M: e._months } : isNumber(e) ? (a = {}, t ? a[t] = e : a.milliseconds = e) : (i = aspNetRegex.exec(e)) ? (o = "-" === i[1] ? -1 : 1, a = { y: 0, d: toInt(i[DATE]) * o, h: toInt(i[HOUR]) * o, m: toInt(i[MINUTE]) * o, s: toInt(i[SECOND]) * o, ms: toInt(absRound(1e3 * i[MILLISECOND])) * o }) : (i = isoRegex.exec(e)) ? a = { y: parseIso(i[2], o = "-" === i[1] ? -1 : 1), M: parseIso(i[3], o), w: parseIso(i[4], o), d: parseIso(i[5], o), h: parseIso(i[6], o), m: parseIso(i[7], o), s: parseIso(i[8], o) } : null == a ? a = {} : "object" == typeof a && ("from" in a || "to" in a) && (n = momentsDifference(createLocal(a.from), createLocal(a.to)), (a = {}).ms = n.milliseconds, a.M = n.months), r = new Duration(a), isDuration(e) && hasOwnProp(e, "_locale") && (r._locale = e._locale), r; }
...
function addSubtract(e, t, o, r) { var n = t._milliseconds, a = absRound(t._days), i = absRound(t._months); e.isValid() && (r = null == r || r, i && setMonth(e, get(e, "Month") + i * o), a && set$1(e, "Date", get(e, "Date") + a * o), n && e._d.setTime(e._d.valueOf() + n * o), r && hooks.updateOffset(e, a || i)); }
...
function setWeekAll(e, t, o, r, n) { var a = dayOfYearFromWeeks(e, t, o, r, n), i = createUTCDate(a.year, 0, a.dayOfYear); return this.year(i.getUTCFullYear()), this.month(i.getUTCMonth()), this.date(i.getUTCDate()), this; }
...
function listWeekdaysImpl(e, t, o, r) { "boolean" == typeof e ? (isNumber(t) && (o = t, t = void 0), t = t || "") : (o = t = e, e = !1, isNumber(t) && (o = t, t = void 0), t = t || ""); var n, a = getLocale(), i = e ? a._week.dow : 0; if (null != o)
    return get$1(t, (o + i) % 7, r, "day"); var s = []; for (n = 0; n < 7; n++)
    s[n] = get$1(t, (n + i) % 7, r, "day"); return s; }
...
function bubble() { var e, t, o, r, n, a = this._milliseconds, i = this._days, s = this._months, l = this._data; return a >= 0 && i >= 0 && s >= 0 || a <= 0 && i <= 0 && s <= 0 || (a += 864e5 * absCeil(monthsToDays(s) + i), i = 0, s = 0), l.milliseconds = a % 1e3, e = absFloor(a / 1e3), l.seconds = e % 60, t = absFloor(e / 60), l.minutes = t % 60, o = absFloor(t / 60), l.hours = o % 24, i += absFloor(o / 24), s += n = absFloor(daysToMonths(i)), i -= absCeil(monthsToDays(n)), r = absFloor(s / 12), s %= 12, l.days = i, l.months = s, l.years = r, this; }
...
function relativeTime$1(e, t, o) { var r = createDuration(e).abs(), n = round(r.as("s")), a = round(r.as("m")), i = round(r.as("h")), s = round(r.as("d")), l = round(r.as("M")), u = round(r.as("y")), c = n <= thresholds.ss && ["s", n] || n < thresholds.s && ["ss", n] || a <= 1 && ["m"] || a < thresholds.m && ["mm", a] || i <= 1 && ["h"] || i < thresholds.h && ["hh", i] || s <= 1 && ["d"] || s < thresholds.d && ["dd", s] || l <= 1 && ["M"] || l < thresholds.M && ["MM", l] || u <= 1 && ["y"] || ["yy", u]; return c[2] = t, c[3] = +e > 0, c[4] = o, substituteTimeAgo.apply(null, c); }
...
function toISOString$1() { if (!this.isValid())
    return this.localeData().invalidDate(); var e, t, o = abs$1(this._milliseconds) / 1e3, r = abs$1(this._days), n = abs$1(this._months); e = absFloor(o / 60), t = absFloor(e / 60), o %= 60, e %= 60; var a = absFloor(n / 12), i = n %= 12, s = r, l = t, u = e, c = o ? o.toFixed(3).replace(/\.?0+$/, "") : "", d = this.asSeconds(); if (!d)
    return "P0D"; var h = d < 0 ? "-" : "", f = sign(this._months) !== sign(d) ? "-" : "", m = sign(this._days) !== sign(d) ? "-" : "", p = sign(this._milliseconds) !== sign(d) ? "-" : ""; return h + "P" + (a ? f + a + "Y" : "") + (i ? f + i + "M" : "") + (s ? m + s + "D" : "") + (l || u || c ? "T" : "") + (l ? p + l + "H" : "") + (u ? p + u + "M" : "") + (c ? p + c + "S" : ""); }
...
function filterRows(e, t, o, r) { return void 0 === e && (e = []), void 0 === t && (t = {}), void 0 === o && (o = ""), void 0 === r && (r = []), e ? t && Object.keys(t).length > 0 || o && r ? (n = t ? Object.keys(t) : [], e.filter(function (e) { if (o && r) {
    ...
    for (var a = !1, i = 0; i < r.length; i++)
        if (e.cells[r[i]].value.toLowerCase().includes(o.toLocaleLowerCase())) {
            a = !0;
            break;
        }
    if (!a)
...
function groupRows(e, t, o) { if (void 0 === e && (e = []), void 0 === t && (t = []), void 0 === o && (o = {}), !e)
    return []; if (!t || 0 === t.length)
    return e; var r = []; return e.forEach(function (e) { for (var n = t[0].column, a = e.cells[n].value, i = null, s = 0; s < r.length; s++) {
    var l = r[s];
    if (l.group.label === a) {
        i = l;
        break;
    }
} for (null === i && r.push(i = { group: { parent: null, column: n, expanded: !1, label: a, children: [], totals: {} }, cells: {} }), s = 1; s < t.length; s++) {
    for (var u = t[s], c = e.cells[u.column].value, d = null, h = 0; h < i.group.children.length; h++) {
        var f = i.group.children[h];
        if (f.group.label === c) {
            d = f;
            break;
        }
    }
    d || i.group.children.push(d = { cells: {}, group: { parent: i, column: u.column, children: [], expanded: !1, label: c, totals: {} } }), i = d;
} i.group.children.push(e), updateGroupTotal(i, o, e); }), adjustGroupsAvarage(r, o), r; }
function updateGroupTotal(e, t, o) { if (e && t) {
    var r = Object.keys(t);
    0 !== r.length && r.forEach(function (r) { var n = e.group.totals[r] || 0, a = o.cells[r], i = "NR" === a.obj.t, s = t[r]; switch (s) {
        ...
        case TotalMode.AVARAGE:
            ...
            break;
        default: console.warn("invalid total mode: " + s);
    } });
} }
...
function calcTotals(e, t) { if (void 0 === e && (e = []), void 0 === t && (t = {}), !e || !t)
    ...
    for (var n = 0, a = o; n < a.length; n++) {
        var i = a[n];
        if (t[i] === TotalMode.AVARAGE) {
            var s = r[i];
            s && e.length > 0 && (r[i] = numeral(s).divide(e.length).value());
        }
        else
            t[i] === TotalMode.COUNT && (r[i] = e.length);
    }
} return r; }
function compareCell(e, t, o) { var r = "A" === o ? 1 : -1, n = e.obj, a = t.obj; if (n.t !== a.t || n.p !== a.p) {
    var i = n.t.localeCompare(a.t);
    return 0 === i && (i = n.p.localeCompare(a.p)), i;
} if ("NR" === n.t) {
    var s = numeral(n.k).value(), l = numeral(a.k).value();
    return s === l ? 0 : s > l ? 1 * r : -1 * r;
} if ("D8" === n.t) {
...
var KetchupDataTable = function () { function e() { this.showFilters = !1, this.filters = {}, this.globalFilter = !1, this.sortEnabled = !0, this.sort = [], this.rowsPerPage = 10, this.paginatorPos = PaginatorPos.TOP, this.columnsWidth = [], this.showHeader = !0, this.showGrid = ShowGrid.NONE, this.groups = [], this.multiSelection = !1, this.globalFilterValue = "", this.currentPage = 1, this.currentRowsPerPage = 10, this.selectedRows = [], this.groupState = {}, this.openedMenu = null, this.density = "medium", this.renderedRows = []; } return e.prototype.rowsPerPageHandler = function (e) { this.currentRowsPerPage = e; }, e.prototype.recalculateRows = function () { this.initRows(); }, e.prototype.componentWillLoad = function () { this.rowsPerPageHandler(this.rowsPerPage), this.initRows(); }, e.prototype.componentDidLoad = function () { this.selectRow && this.selectRow > 0 && this.selectRow <= this.renderedRows.length && (this.selectedRows = [], this.selectedRows.push(this.renderedRows[this.selectRow - 1]), this.kupAutoRowSelect.emit({ selectedRow: this.selectedRows[0] })); }, e.prototype.getColumns = function () { return this.data && this.data.columns ? this.data.columns : [{ title: "", name: "", size: 0 }]; }, e.prototype.getVisibleColumns = function () { var e = this, t = this.getColumns().filter(function (e) { return !e.hasOwnProperty("visible") || e.visible; }); return this.isGrouping() ? t.filter(function (t) { for (var o = null, r = 0, n = e.groups; r < n.length; r++) {
    ...
    var o = e.group, r = this.groupState[o.label];
    r ? o.expanded = r.expanded : this.groupState[o.label] = o, o.children.forEach(function (e) { return t.adjustGroupStateFromRow(e); });
    ...
    if (0 === e.group.children.length)
        return null;
    for (var n = "mdi mdi-chevron-" + (e.group.expanded ? "right" : "down"), a = [], i = [], s = 0; s < t; s++)
        i.push(mycomponent_core_js_1.h("span", { class: "indent" }));
    if (this.hasTotals()) {
        (c = []).push(mycomponent_core_js_1.h("td", { colSpan: this.multiSelection ? 2 : 1 }, i, mycomponent_core_js_1.h("span", { role: "button", "aria-label": "Row expander", class: n, onClick: function (t) { t.stopPropagation(), o.onRowExpand(e); } }), e.group.label));
        ...
        a.push(mycomponent_core_js_1.h("tr", { class: "group", onClick: function () { return o.onRowExpand(e); } }, mycomponent_core_js_1.h("td", { colSpan: this.calculateColspan() }, i, mycomponent_core_js_1.h("span", { role: "button", "aria-label": "Row expander", class: "row-expander " + n, onClick: function (t) { t.stopPropagation(), o.onRowExpand(e); } }), e.group.label)));
...
} var c = r.map(function (r, n) { var a = r.name, i = []; if (!(0 !== n || o.isGrouping() && o.hasTotals()))
    for (var s = 0; s < t; s++)
        i.push(mycomponent_core_js_1.h("span", { class: "indent" })); var l = e.cells[a], u = null; l.options && (u = mycomponent_core_js_1.h("span", { class: "options", role: "button", "aria-label": "Opzioni oggetto", title: "Opzioni oggetto", onClick: function () { return o.onOptionClicked(a, e); } }, mycomponent_core_js_1.h("i", { class: "mdi mdi-settings" }))); var c = o.renderCell(l), d = { number: isNumber$1(l.obj) }; return mycomponent_core_js_1.h("td", { "data-column": a, style: l.style, class: d }, i, c, u); }), d = null; this.multiSelection && (d = mycomponent_core_js_1.h("td", null, mycomponent_core_js_1.h("input", { type: "checkbox", checked: this.selectedRows.includes(e), onClick: function (e) { return e.stopPropagation(); }, onChange: function (t) { return o.onRowCheckboxSelection(t, e); } }))); var f = null; this.isGrouping() && this.hasTotals() && (f = mycomponent_core_js_1.h("td", null)), this.renderedRows.push(e); var m = null; if (this.hasRowActions()) {
    var p = this.renderActions(this.rowActions, e, "default"), g = null, y = null;
    e.actions ? y = this.renderActions(e.actions, e, "variable") : g = mycomponent_core_js_1.h("span", { title: "Espandi voci", class: "row-action mdi mdi-chevron-right", onClick: function (t) { return o.onRowActionExpanderClick(t, e); }, role: "button", "aria-label": "Espandi voci", "aria-pressed": "false" }), m = mycomponent_core_js_1.h("td", null, p, g, y);
} var k = { selected: this.selectedRows.includes(e) }; return mycomponent_core_js_1.h("tr", { class: k, onClick: function (t) { return o.onRowClick(t, e); } }, d, f, m, c); }, e.prototype.renderActions = function (e, t, o) { var r = this; return e.map(function (e, n) { return mycomponent_core_js_1.h("span", { title: e.text, class: "row-action " + e.icon, onClick: function (a) { return r.onDefaultRowActionClick(a, { action: e, index: n, row: t, type: o }); }, role: "button", "aria-label": e.text, "aria-pressed": "false" }); }); }, e.prototype.renderCell = function (e) { var t = e.value; return isIcon(e.obj) || isVoCodver(e.obj) ? t = mycomponent_core_js_1.h("span", { class: e.value }) : isImage(e.obj) ? t = mycomponent_core_js_1.h("img", { src: e.value, alt: "", width: "64", height: "64" }) : isLink(e.obj) ? t = mycomponent_core_js_1.h("a", { href: e.value, target: "_blank" }, e.value) : isBar(e.obj) && (t = mycomponent_core_js_1.h("kup-graphic-cell", { value: e.value })), mycomponent_core_js_1.h("span", { class: "cell-content" }, t); }, e.prototype.render = function () { var e = this; this.renderedRows = []; var t = null; 0 === this.paginatedRows.length ? t = mycomponent_core_js_1.h("tr", null, mycomponent_core_js_1.h("td", { colSpan: this.calculateColspan() }, "Empty data")) : (t = [], this.paginatedRows.map(function (t) { return e.renderRow(t); }).forEach(function (e) { Array.isArray(e) ? e.forEach(function (e) { return t.push(e); }) : t.push(e); })); var o = this.renderHeader(), r = this.renderFooter(), n = null; this.globalFilter && (n = mycomponent_core_js_1.h("div", { id: "globalFilter" }, mycomponent_core_js_1.h("kup-text-input", { label: "Global filter", onKetchupTextInputUpdated: function (t) { return e.onGlobalFilterChange(t); } }))); var a = null; PaginatorPos.TOP !== this.paginatorPos && PaginatorPos.BOTH !== this.paginatorPos || (a = mycomponent_core_js_1.h("kup-paginator", { id: "top-paginator", max: this.rows.length, perPage: this.rowsPerPage, selectedPerPage: this.currentRowsPerPage, currentPage: this.currentPage, onKupPageChanged: function (t) { return e.handlePageChanged(t); }, onKupRowsPerPageChanged: function (t) { return e.handleRowsPerPageChanged(t); } })); var i = null; PaginatorPos.BOTTOM !== this.paginatorPos && PaginatorPos.BOTH !== this.paginatorPos || (i = mycomponent_core_js_1.h("kup-paginator", { id: "bottom-paginator", max: this.rows.length, perPage: this.rowsPerPage, selectedPerPage: this.currentRowsPerPage, currentPage: this.currentPage, onKupPageChanged: function (t) { return e.handlePageChanged(t); }, onKupRowsPerPageChanged: function (t) { return e.handleRowsPerPageChanged(t); } })); var s = null; if (this.isGrouping()) {
...
function getColorFromString(e) { var t = e.indexOf("R"), o = e.indexOf("G"), r = e.indexOf("B"); if (!(t < 0 || o < 0 || r < 0)) {
    var n = e.substring(t + 1, t + 4), a = e.substring(o + 1, o + 4), i = e.substring(r + 1, r + 4);
    try {
        return new Color(parseInt(n), parseInt(a), parseInt(i));
    }
    catch (e) {
        console.error(e);
    }
...
var GraphicElement = function () { function e() { this.width = 100, this.height = 100, this.color = null, this.shape = "bar"; } return e.prototype.init = function (e) { var t = this; e.forEach(function (e) { e.toUpperCase().startsWith("HEIGHT;") ? t.initHeight(e) : e.toUpperCase().startsWith("SHAPE;") ? t.initShape(e) : e.toUpperCase().startsWith("BCOLOR;") || t.initColor(e); }); }, e.prototype.initColor = function (e) { if (e.length > 11 && this.isValidColor(e)) {
    ...
    var a = e.indexOf("R"), i = e.indexOf("G"), s = e.indexOf("B");
    if (r = e.substring(a + 1, i), t[0] = parseInt(r), isNaN(t[0]) && (o = !0), r = e.substring(i + 1, s), t[1] = parseInt(r), isNaN(t[1]) && (o = !0), r = e.substring(s + 1), t[2] = parseInt(r), isNaN(t[2]) && (o = !0), o)
        return !1;
} return !(t[0] < 0 || t[0] > 255 || t[1] < 0 || t[1] > 255 || t[2] < 0 || t[2] > 255); }, e.prototype.getHeight = function () { return this.height; }, e.prototype.getWidth = function () { return this.width; }, e.prototype.getShape = function () { return this.shape; }, e.prototype.getColor = function () { return this.color; }, e; }(), Color = function () { function e(e, t, o) { this.r = e, this.g = t, this.b = o; } return e.prototype.toString = function () { return "rgb(" + this.r + "," + this.g + "," + this.b + ")"; }, e; }(), KetchupDataTable$1 = function () { function e() { this.height = 30, this.width = 300, this.graphic_element_marker_splitter = "\\", this.graphic_element_splitter = "\\AND\\", this.background_color = "BCOLOR;R255G000B000", this.default_color = new Color(0, 0, 0); } return e.prototype.onValueChange = function () { this.draw(); }, e.prototype.componentDidLoad = function () { this.draw(); }, e.prototype.draw = function () { this.value && this.canvas.getContext && (this.ctx = this.canvas.getContext("2d"), this.drawGraphicCell()); }, e.prototype.drawGraphicCell = function () { var e = this; this.value.split(this.graphic_element_splitter).forEach(function (t, o) { var r = [], n = "SHAPE;BAR", a = e.background_color, i = "HEIGHT;100", s = t.split(e.graphic_element_marker_splitter), l = [], u = []; if (s.forEach(function (t) { e.isShapeMarker(t) ? n = t : e.isBgColorMarker(t) ? a = t : e.isHeightMarker(t) ? i = t : e.isDecoratorMarker(t) ? u.push(t) : l.push(t); }), l.forEach(function (e) { var t = new GraphicElement; t.init([n, a, i, e]), r.push(t); }), 0 === o && a !== e.background_color) {
    var c = getColorFromString(a.substring("BCOLOR;".length));
    e.drawRect(0, 0, e.canvas.width, e.canvas.height, c);
} var d = 0; r.forEach(function (t) { switch (t.getShape()) {
    case "circle":
...
function getRawTag(e) { var t = hasOwnProperty.call(e, symToStringTag), o = e[symToStringTag]; try {
    e[symToStringTag] = void 0;
    var r = !0;
}
catch (e) { } var n = nativeObjectToString.call(e); return r && (t ? e[symToStringTag] = o : delete e[symToStringTag]), n; }
