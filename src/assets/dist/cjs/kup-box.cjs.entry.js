        ...
        if (boxObject.value) {
            ...
            if (cell) {
                ...
                if (__chunk_4.isImage(cell.obj)) {
                    ...
                    boContent = (__chunk_1.h("kup-button", Object.assign({}, __chunk_4.createJ4objButtonConfig(cell))));
                }
                else if (__chunk_4.isProgressBar(cell.obj)) {
                ...
                else if (__chunk_4.isIcon(cell.obj)) {
