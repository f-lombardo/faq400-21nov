...
class KupCalendar {
    constructor(hostRef) {
        ...
        this.kupCalendarEventClicked = __chunk_1.createEvent(this, "kupCalendarEventClicked", 6);
        this.kupCalendarDateClicked = __chunk_1.createEvent(this, "kupCalendarDateClicked", 6);
        this.kupCalendarEventDropped = __chunk_1.createEvent(this, "kupCalendarEventDropped", 6);
        this.kupCalendarViewChanged = __chunk_1.createEvent(this, "kupCalendarViewChanged", 6);
    }
    // ---- Private methods ----
    getColumns() {
        ...
        return this.getRows().map((row) => {
            ...
            if (isHourRange) {
                ...
                if (startCell && endCell) {
                    const momentStart = __chunk_3.moment(startCell.value, 'HH:mm:ss');
                    const momentEnd = __chunk_3.moment(endCell.value, 'HH:mm:ss');
    ...
    emitNavEvent() {
        ...
        const to = __chunk_3.moment(this.calendar.view.currentEnd)
            .subtract(1, 'day')
            .toDate();
