...
class KupPaginator {
    ...
    getGoToPageOptions(maxNumberOfPage) {
        ...
        goToPageOptions.push(__chunk_1.h("option", { value: "1", selected: this.currentPage === 1 }, "1"));
        for (let i = 2; i <= maxNumberOfPage; i++) {
            goToPageOptions.push(__chunk_1.h("option", { value: i, selected: this.currentPage === i }, i));
        }
    ...
    getRowsPerPageOptions() {
        ...
        if (this.currentPage != this.max) {
            ...
            while (i < this.max) {
                rowsPerPageOptions.push(__chunk_1.h("option", { value: i, selected: i === this.selectedPerPage }, i));
                i = i * 2;
            }
            // adding 'max' option
            rowsPerPageOptions.push(__chunk_1.h("option", { value: this.max, selected: this.max === this.perPage }, this.max));
        }
        else {
            rowsPerPageOptions.push(__chunk_1.h("option", { value: this.perPage, selected: true }, this.perPage));
        }
        return rowsPerPageOptions;
    }
    render() {
        ...
        return (__chunk_1.h("div", { id: "paginator" }, __chunk_1.h("div", { class: "align-left" }, "Pagina", __chunk_1.h("span", { class: "prev-page" }, __chunk_1.h("icon", { className: prevPageClassName, onclick: () => this.onPrevPage() })), __chunk_1.h("select", { onChange: (e) => this.onGoToPage(e) }, goToPageOptions), __chunk_1.h("span", { class: "next-page" }, __chunk_1.h("icon", { className: nextPageClassName, onclick: () => this.onNextPage() })), "Di ", maxNumberOfPage), __chunk_1.h("div", { class: "align-right" }, __chunk_1.h("span", { class: "nextPageGroup" }, "Numero risultati: ", this.max), __chunk_1.h("slot", { name: "more-results" }), "Mostra", __chunk_1.h("select", { onChange: (e) => this.onRowsPerPage(e) }, rowsPerPageOptions), "righe per pagina")));
    }
