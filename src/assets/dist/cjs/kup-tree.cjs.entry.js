 ...
 * @constant
 */
const treeExpandedPropName = 'isExpanded';
...
class KupTree {
    constructor(hostRef) {
        ...
        this.kupTreeNodeCollapse = __chunk_1.createEvent(this, "kupTreeNodeCollapse", 6);
        this.kupTreeNodeExpand = __chunk_1.createEvent(this, "kupTreeNodeExpand", 6);
        this.kupTreeNodeSelected = __chunk_1.createEvent(this, "kupTreeNodeSelected", 6);
    }
    //-------- Lifecycle hooks --------
    componentWillLoad() {
        if (this.data) {
    ...
    renderOptionElement(cell, column, treeNode) {
        return (__chunk_1.h("span", { "aria-label": "Opzioni oggetto", class: "options mdi mdi-settings", role: "button", title: "Opzioni oggetto", onClick: (e) => this.hdlOptionClicked(e, cell, column, treeNode) }));
    }
    /**
    ...
    renderCell(cell, cellData, previousRowCellValue) {
        ...
        if (__chunk_4.isIcon(cell.obj) || __chunk_4.isVoCodver(cell.obj)) {
            ...
            content = (__chunk_1.h("kup-checkbox", { checked: !!cell.obj.k, disabled: cellData.treeNode.hasOwnProperty('readOnly') ? cellData.treeNode.readOnly : true }));
        }
        ...
        let cellElements = [];
        cellElements.push(__chunk_1.h("span", { class: "cell-content", style: __chunk_3.styleHasBorderRadius(cell) ? cell.style : null }, content));
        /**
        ...
        return __chunk_1.h("td", { style: !__chunk_3.styleHasBorderRadius(cell) ? cell.style : null }, cellElements);
    }
    /**
     ...
     */
    renderHeader() {
        return this.visibleColumns.map(column => __chunk_1.h("th", null, __chunk_1.h("span", { class: "column-title" }, column.title)));
    }
    /**
    ...
    renderTreeNode(treeNodeData, treeNodePath, treeNodeDepth = 0) {
        ...
        let indent = treeNodeDepth
            ? __chunk_1.h("span", { class: "kup-tree__indent", style: { ["--tree-node_depth"]: treeNodeDepth.toString() } })
            : null;
        ...
        let treeExpandIcon = __chunk_1.h("span", { class: "kup-tree__icon kup-tree__node__expander" + (hasExpandIcon ? " mdi mdi-menu-down" : ""), onClick: hasExpandIcon && !treeNodeData.disabled ? () => this.hdlTreeNodeExpanderClicked(treeNodeData, treeNodePath) : null });
        // When TreeNode icons are visible, creates the icon if one is specified
        let treeNodeIcon = this.showIcons ? __chunk_1.h("span", { class: "kup-tree__icon mdi mdi-" + treeNodeData.iconClass }) : null;
        ...
        return (__chunk_1.h("tr", Object.assign({ class: {
                "kup-tree__node": true,
            ...
            }, "data-tree-path": treeNodePath }, treeNodeOptions), __chunk_1.h("td", { style: treeNodeData.style || null }, indent, treeExpandIcon, treeNodeIcon, __chunk_1.h("span", { class: "cell-content" }, treeNodeData.value), treeNodeOptionIcon), treeNodeCells));
    }
    /**
    ...
    render() {
        ...
        if (this.data && this.data.length) {
            ...
            treeNodes.push(__chunk_1.h("tr", null, __chunk_1.h("td", null, "Nessun elemento nell'albero")));
        }
        // Calculates if header must be shown or not
        const visibleHeader = this.showHeader && this.showColumns;
        return [
            __chunk_1.h("link", { href: 'https://cdn.materialdesignicons.com/4.5.95/css/materialdesignicons.min.css', rel: "stylesheet", type: "text/css" }),
            __chunk_1.h("table", { class: "kup-tree", "data-show-columns": this.showColumns, "data-show-object-navigation": this.showObjectNavigation }, __chunk_1.h("thead", { class: { 'header--is-visible': visibleHeader } }, __chunk_1.h("tr", null, __chunk_1.h("th", null), visibleHeader ? this.renderHeader() : null)), __chunk_1.h("tbody", null, treeNodes))
        ];
    }
