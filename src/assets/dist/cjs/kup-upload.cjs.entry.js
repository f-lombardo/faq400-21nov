...
class KupUpload {
    constructor(hostRef) {
        ...
        this.ketchupFileUploaded = __chunk_1.createEvent(this, "ketchupFileUploaded", 7);
        this.ketchupFileRejected = __chunk_1.createEvent(this, "ketchupFileRejected", 7);
    }
    /*
    ...
    */
    render() {
        ...
        */
        ...
        file-reject
        */
        return (__chunk_1.h($DynamicComponent, Object.assign({}, confObj, { "onUpload-error": (ev) => {
