...
class KupBtn {
    ...
    static get style() { return ".btn-container.sc-kup-btn{border-collapse:collapse}.btn-container.fillspace.sc-kup-btn{width:100%}.btn-container.sc-kup-btn   tbody.sc-kup-btn   tr.sc-kup-btn   td.sc-kup-btn{padding:3px}"; }
}
