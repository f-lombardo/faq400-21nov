...
class KetchupRadio {
    ...
    static get style() { return ".sc-ketchup-radio-h{--rad_font-size:var(--kup-radio_font-size,14px);--rad_border-color:var(--kup-radio_border-color,grey);--rad_border-color--selected:var(--kup-radio_border-color,#676767);--rad_color:var(--kup-radio_color,#4e908f);--rad_tr-duration:var(--kup-radio_transition-duration,0.6s)}.ketchup-radio__group.sc-ketchup-radio{list-style-type:none;margin:0;padding:0;position:relative;z-index:0}.ketchup-radio__group.ketchup-radio__group--horizontal.sc-ketchup-radio{display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap}.ketchup-radio__item.sc-ketchup-radio{margin:10px 12px}.ketchup-radio__item.sc-ketchup-radio, .ketchup-radio__item.sc-ketchup-radio > div.sc-ketchup-radio{-ms-flex-align:center;align-items:center;display:-ms-inline-flexbox;display:inline-flex;-ms-flex-pack:center;justify-content:center;position:relative;z-index:0}.ketchup-radio__item.sc-ketchup-radio > div.sc-ketchup-radio{height:calc(var(--rad_font-size) * 1.4);width:calc(var(--rad_font-size) * 1.4)}.ketchup-radio__item.sc-ketchup-radio > div.sc-ketchup-radio:after, .ketchup-radio__item.sc-ketchup-radio > div.sc-ketchup-radio:before{border-radius:50%;-webkit-box-sizing:border-box;box-sizing:border-box;content:\"\"}.ketchup-radio__item.sc-ketchup-radio > div.sc-ketchup-radio:before{border:1px solid var(--rad_border-color);height:100%;left:0;position:absolute;top:0;width:100%;z-index:0}.ketchup-radio__item.sc-ketchup-radio > div.sc-ketchup-radio:after{background-color:var(--rad_color);height:calc(100% - 4px);position:relative;opacity:0;-webkit-transition:opacity var(--rad_tr-duration);transition:opacity var(--rad_tr-duration);width:calc(100% - 4px);z-index:1}.ketchup-radio__item.sc-ketchup-radio > div.sc-ketchup-radio > input.sc-ketchup-radio{cursor:pointer;height:100%;left:0;margin:0;opacity:0;position:absolute;top:0;width:100%;z-index:2}.ketchup-radio__item--selected.sc-ketchup-radio   div.sc-ketchup-radio:after{opacity:1}.ketchup-radio__item.sc-ketchup-radio   label.sc-ketchup-radio{cursor:pointer;font-size:var(--rad_font-size);margin-left:10px}"; }
}
