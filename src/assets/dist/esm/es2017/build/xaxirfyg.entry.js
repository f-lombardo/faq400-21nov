...
class KetchupPaginator {
    ...
    static get style() { return "\@import url(https://cdn.materialdesignicons.com/3.6.95/css/materialdesignicons.min.css);#paginator{margin:.5rem 0;display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;-ms-flex-pack:justify;justify-content:space-between}#paginator icon{cursor:pointer}#paginator icon.disabled{cursor:default;opacity:.3}#paginator .nextPage,#paginator .nextPageGroup,#paginator .prevPage,#paginator select{margin:0 .1rem}#paginator .nextPageGroup{border-right:1px solid #000;padding-right:.3rem}"; }
}

export { KetchupDataTable as KupDataTable, KetchupPaginator as KupPaginator };
