...
class KupButton {
    ...
    render() {
        ...
        return [
            ...
            h("button", { type: "button", class: btnClass, title: title, onClick: () => this.onBtnClickedHandler() }, icon, btnLabel),
        ];
    }
...
class KupPortalInstance {
    ...
    get port() { return getElement(this); }
...
class KupRadio {
    ...
    radioElementsComposer() {
        return this.items.map((radio) => {
            ...
            return h("li", { class: 'kup-radio__item' + (this.selectedRadio && this.selectedRadio[this.valueField] === radio[this.valueField] ? ' kup-radio__item--selected' : '') }, h("div", null, h("input", { id: uId, type: "radio", name: this.radioName, value: radio[this.valueField], onChange: this.onRadioChanged.bind(this, radio) })), h("label", { htmlFor: uId }, radio[this.displayedField]));
        });
    }
    render() {
