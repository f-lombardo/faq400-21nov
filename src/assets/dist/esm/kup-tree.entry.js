...
import { d as styleHasBorderRadius } from './chunk-93a43134.js';
import { c as isIcon, g as isVoCodver, d as isImage, e as isLink, b as isCheckbox, i as isBar } from './chunk-a5dfc366.js';
...
class KupTree {
     ...
     */
    renderHeader() {
        return this.visibleColumns.map(column => h("th", null, h("span", { class: "column-title" }, column.title)));
    }
    /**
