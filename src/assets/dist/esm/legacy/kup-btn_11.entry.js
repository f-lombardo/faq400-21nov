...
var KupCombo = /** @class */ (function () {
    ...
    KupCombo.prototype.composeList = function () {
        ...
        return h("div", { class: this.baseClass + '__menu' + (this.isOpen ? ' is-open' : '') +
                ...
                + (this.usePortal ? ' is-using-portal' : '') }, h("div", { class: this.baseClass + '__filter' }, h("kup-text-input", { onKetchupTextInputUpdated: this.onFilterUpdate.bind(this) })), h("ul", { class: this.baseClass + '__list' }, this.items.filter(function (item) { return !_this.filter || item[_this.displayedField].toLowerCase().indexOf(_this.filter) >= 0; })
    ...
    KupCombo.prototype.render = function () {
        ...
        return ([
            h("div", { class: containerClass + (this.isClearable ? ' ' + containerClass + '--clearable' : ''), ref: function (el) { return _this.comboText = el; } }, h("span", { class: this.baseClass + '__current-value', onClick: this.onComboClick.bind(this) }, this.selected ? this.selected[this.displayedField] : '', h("svg", { class: this.baseClass + '__icon ' + this.baseClass + '__chevron' + (this.isOpen ? ' ' + this.baseClass + '__chevron--open' : ''), viewBox: "0 0 24 24" }, h("path", { d: "M7.41,8.58L12,13.17L16.59,8.58L18,10L12,16L6,10L7.41,8.58Z" }))), this.isClearable ?
                ...
                null),
            this.usePortal ?
                h("kup-portal", { isVisible: this.isOpen, mirroredCssVars: this.internalCssVars, nodes: this.composeList(), portalParentRef: this.comboEl, ref: function (el) { return _this.portalRef = el; },
...
var KupFld = /** @class */ (function () {
    ...
    KupFld.prototype.render = function () {
        ...
        var $DynamicComponent = ('kup-' + type); // TODO check if there is a better typing
...
var KupPortal = /** @class */ (function () {
    ...
    KupPortal.prototype.componentWillRender = function () {
        // Updates tree node
