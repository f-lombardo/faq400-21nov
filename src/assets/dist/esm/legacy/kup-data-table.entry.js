...
var KupDataTable = /** @class */ (function () {
    ...
    KupDataTable.prototype.renderPaginator = function (top) {
        var _this = this;
        return (h("div", { class: "paginator-wrapper" }, h("kup-paginator", { id: top ? 'top-paginator' : 'bottom-paginator', max: this.rows.length, perPage: this.rowsPerPage, selectedPerPage: this.currentRowsPerPage, currentPage: this.currentPage, onKupPageChanged: function (e) { return _this.handlePageChanged(e); }, onKupRowsPerPageChanged: function (e) { return _this.handleRowsPerPageChanged(e); } }, this.showLoadMore ? this.renderLoadMoreButton() : null), this.renderDensityPanel(top)));
    };
    KupDataTable.prototype.renderDensityPanel = function (top) {
        var _this = this;
        return (h("div", { class: "density-panel" }, h("svg", { version: "1.1", width: "24", height: "24", viewBox: "0 0 24 24" }, h("path", { d: "M3,6H21V8H3V6M3,11H21V13H3V11M3,16H21V18H3V16Z" })), h("div", { role: "button", tabindex: "0", onClick: function (e) { return _this.toggleDensityVisibility(e, top); } }, h("svg", { version: "1.1", width: "24", height: "24", viewBox: "0 0 24 24" }, h("path", { d: "M7,10L12,15L17,10H7Z" }))), h("div", { class: {
            ...
            }, onClick: function () { return (_this.density = 'big'); }, role: "button", tabindex: "0", "aria-pressed": this.density === 'big' ? 'true' : 'false' }, h("svg", { version: "1.1", width: "24", height: "24", viewBox: "0 0 24 24" }, h("path", { d: "M3,4H21V8H3V4M3,10H21V14H3V10M3,16H21V20H3V16Z" })), "Bassa"), h("div", { class: {
                wrapper: true,
                active: this.density === 'medium',
            }, onClick: function () { return (_this.density = 'medium'); }, role: "button", tabindex: "0", "aria-pressed": this.density === 'medium' ? 'true' : 'false' }, h("svg", { version: "1.1", width: "24", height: "24", viewBox: "0 0 24 24" }, h("path", { d: "M3,6H21V8H3V6M3,11H21V13H3V11M3,16H21V18H3V16Z" })), "Media"), h("div", { class: {
                wrapper: true,
                active: this.density === 'small',
            }, onClick: function () { return (_this.density = 'small'); }, role: "button", tabindex: "0", "aria-pressed": this.density === 'small' ? 'true' : 'false' }, h("svg", { version: "1.1", width: "24", height: "24", viewBox: "0 0 24 24" }, h("path", { d: "M3,3H21V5H3V3M3,7H21V9H3V7M3,11H21V13H3V11M3,15H21V17H3V15M3,19H21V21H3V19Z" })), "Alta"))));
    };
    KupDataTable.prototype.render = function () {
        ...
        return (h("div", { id: "data-table-wrapper" }, h("div", { class: "above-wrapper" }, paginatorTop, globalFilter), h("div", { class: "below-wrapper" }, groupChips, h("table", { class: tableClass }, h("thead", { hidden: !this.showHeader, ref: function (el) { return (_this.theadRef = el); } }, h("tr", null, header)), h("tbody", null, rows), footer)), paginatorBottom));
    };
