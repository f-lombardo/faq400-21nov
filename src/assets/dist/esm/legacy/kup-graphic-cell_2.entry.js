...
var KupPaginator = /** @class */ (function () {
    ...
    KupPaginator.prototype.onGoToPage = function (_a) {
        var target = _a.target;
        this.kupPageChanged.emit({
            newPage: parseInt(target.value),
        });
    };
    KupPaginator.prototype.onRowsPerPage = function (_a) {
        var target = _a.target;
    ...
    KupPaginator.prototype.render = function () {
        ...
        var goToPageOptions = this.getGoToPageOptions(maxNumberOfPage);
        var rowsPerPageOptions = this.getRowsPerPageOptions();
        return (h("div", { id: "paginator" }, h("div", { class: "align-left" }, "Pagina", h("span", { class: "prev-page" }, h("icon", { className: prevPageClassName, onclick: function () { return _this.onPrevPage(); } })), h("select", { onChange: function (e) { return _this.onGoToPage(e); } }, goToPageOptions), h("span", { class: "next-page" }, h("icon", { className: nextPageClassName, onclick: function () { return _this.onNextPage(); } })), "Di ", maxNumberOfPage), h("div", { class: "align-right" }, h("span", { class: "nextPageGroup" }, "Numero risultati: ", this.max), h("slot", { name: "more-results" }), "Mostra", h("select", { onChange: function (e) { return _this.onRowsPerPage(e); } }, rowsPerPageOptions), "righe per pagina")));
    };
    Object.defineProperty(KupPaginator, "style", {
        get: function () { return "\@import url(https://cdn.materialdesignicons.com/3.6.95/css/materialdesignicons.min.css);:host{--int_text-color:var(--kup-paginator_text-color,$mainTextColor);--int_font-size:var(--kup-paginator_font-size,1rem)}#paginator{color:var(--int_text-color);margin:.5rem 0;display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap;-ms-flex-pack:justify;justify-content:space-between;font-size:var(--int_font-size)}#paginator icon{cursor:pointer;opacity:1;-webkit-transition:opacity .1s ease-in-out;transition:opacity .1s ease-in-out}#paginator icon:hover:not(.disabled){opacity:.75}#paginator icon.disabled{cursor:default;opacity:.3}#paginator .nextPageGroup,#paginator select{margin:0 .5rem}#paginator .next-page,#paginator .prev-page{margin:0 .25rem}#paginator .nextPageGroup{padding-right:1.5rem}"; },
        enumerable: true,
        configurable: true
    });
    return KupPaginator;
