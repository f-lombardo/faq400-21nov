...
describe("SEC", () => {
  ...
  it("renders sections (column layout)", () => {
    ...
    expect(sections.at(0).html()).toBe(
      `<div class="section"><sec-stub section="[object Object]"></sec-stub><sec-stub section="[object Object]"></sec-stub></div>`
    );
  });
  ...
  it("renders sections (row layout)", () => {
    ...
    expect(sections).toHaveLength(1);
    expect(sections.at(0).html()).toBe(
      `<div class="section row"><sec-stub section="[object Object]"></sec-stub><sec-stub section="[object Object]"></sec-stub></div>`
    );
  });
});
